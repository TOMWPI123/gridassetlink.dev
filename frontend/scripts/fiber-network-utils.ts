...
export const DISTRIBUTION_POLES_LITE_PATH = path.join(OUTPUT_DIR, "iso-ne-synthetic-distribution-poles-lite.geojson");
export const DISTRIBUTION_POLES_LITE_META_PATH = path.join(OUTPUT_DIR, "iso-ne-synthetic-distribution-poles-lite.meta.json");
