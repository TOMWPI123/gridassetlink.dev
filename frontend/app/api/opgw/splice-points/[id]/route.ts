...
export async function GET(_request: Request, { params }: RouteContext) {
  ...
  return NextResponse.json({
    splicePoint: view.splicePoint,
    closure: view.closure,
    connectedCableSectionCount: view.connectedCableSections.length,
    serviceCount: view.services.length,
    continuityPathCount: view.continuityPaths.length,
